...
```vue
<template>
  <CTree :data="data" lineable></CTree>
</template>
<script setup>
import { ref } from 'vue'
const data = ref([
...
```vue
<template>
  <CTree :data="data" checkable></CTree>
</template>
<script setup>
import { ref } from 'vue'
const data = ref([
...
```vue
<template>
  <CTree :data="data" operable></CTree>
</template>
<script lang="ts">
...
```vue
<template>
  <CTree :data="data" @lazy-load="lazyLoad"></CTree>
</template>
<script>
import { defineComponent, ref } from 'vue';
...
<template>
  <h6><p>默认行为</p></h6>
  <CTree :data="data" dragdrop></CTree>

  <h6><p>排序</p></h6>
  <CTree :data="data" :dragdrop="{ dropPrev: true, dropNext: true, dropInner: true }"></CTree>
</template>
<script lang="ts">
import { defineComponent, ref } from 'vue'
...
```vue
<template>
  <CTree :data="data" :height="300"></CTree>
</template>
<script lang="ts">
import { defineComponent, ref } from 'vue';
