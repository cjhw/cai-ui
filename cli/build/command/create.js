...
var create_component_1 = __importDefault(require("../shared/create-component"));
// 创建类型
                    ...
                    return [4 /*yield*/, inquirer_1["default"].prompt([
                            {
                                ...
                                type: 'list',
                                // 提示信息
                                message: (0, kolorist_1.blue)('（必填）请选择创建类型：'),
                                // 选项列表
                ...
                case 4: return [4 /*yield*/, inquirer_1["default"].prompt([
                        {
                            name: 'name',
                            type: 'input',
                            message: (0, kolorist_1.blue)('（必填）请输入组件name，将用作文件名和文件夹名称:'),
                        ...
                        },
                        {
                            name: 'title',
                            type: 'input',
                            message: (0, kolorist_1.blue)('（必填）请输入组件中文名称，将用作文档列表中显示:'),
                            validate: function (value) {
                                if (value.trim() === '') {
                                    return '组件名称不能为空！';
                                }
                        ...
                        },
                        {
                            name: 'category',
                            type: 'list',
                            message: (0, kolorist_1.blue)('（必填）请选择组件分类，将用作文档列表分类中:'),
